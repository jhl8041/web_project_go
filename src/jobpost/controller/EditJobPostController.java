...
public class EditJobPostController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			jp.setNum(Integer.parseInt(multi.getParameter("postnum")));
			jp.setPostLike(Integer.parseInt(multi.getParameter("like")));
			jp.setPostDislike(Integer.parseInt(multi.getParameter("dislike")));
			jp.setPostView(Integer.parseInt(multi.getParameter("view")));
