...
<body>
	...
	<table id = "calendar">
		...
		<caption>
			<input type=button onclick="btn_m_year()"  value="일년전">
			<input type=button onclick="location.href='InsertController3"  value="한달전"'>
			<input type=button onclick="location.href='InsertController'"  value="오늘">
			<span>${year}</span>년
			<span>${month}</span>월
			<input type=button onclick="location.href='InsertController4'"  value="한달후">
			<input type=button onclick="btn_p_year()"  value="일년후">
		</caption>
