					...
					<div class="row" >
							<div class="card shadow mb-4">
								<div class="card-header py-3">
									<h6 class="m-0 font-weight-bold text-primary">일정 추가/수정</h6>
								</div>
								<div class="card-body">		
								<form id=jobpostform name=jobpostform method=post action="${pageContext.request.contextPath}/AddCalendarController">
									...
									<div class="form-group">
										...
										<div class="form-inline">
											<input type=text id="calstart" class="form-control" name=calstart width="200" placeholder="시작일" />
											...
											<input type=text id="calend" class="form-control" name=calend style="margin-left:10px;" width="200" placeholder="종료일" />
