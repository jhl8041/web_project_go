...
function idResult(){
    ...
    $.ajax({
        url : baseUrl+"/FindLostIdController",
        type : "POST",
			...
			<div class="wrap-login100">
				<form class="login100-form validate-form p-l-55 p-r-55 p-t-178" action="${pageContext.request.contextPath}/LoginController" method=post name=form id=form>
					...
					<div class="container-login100-form-btn">
				  		<input class="login100-form-btn" style="margin-top:10px" type=button value=아이디검색 onclick="idResult()">
				  	</div>
				  	<div class="container-login100-form-btn">
				  		<input class="login100-form-btn" style="margin-top:10px" type=button value="비밀번호 재설정" onclick="location.href='${pageContext.request.contextPath}/member/ResetPwd.jsp'">
				  	</div>
				  	<div class="container-login100-form-btn">
				  		<input class="login100-form-btn" style="margin-top:10px;margin-bottom:50px" type=button value="로그인화면으로" onclick="location.href='${pageContext.request.contextPath}/member/LoginForm.jsp'">
				  	</div>
