		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="row" >
						<div style="min-width:1500px;margin-left:100px;margin-top:50px"> 
									...
									<table class="table table-hover table-fixed">
									  ...
									  <tbody style="text-align:center">
									  	<c:forEach var="b" items="${list}" >
										    <tr onclick="location.href='${pageContext.request.contextPath }/ReadController?board_seq=${b.board_seq}'">
										      <td>${b.board_seq }</td>
										      <td style="width:800px;text-align:left">${b.board_title}</td>
